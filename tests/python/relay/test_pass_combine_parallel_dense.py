...
def test_combine_parallel_dense_flat():
    ...
    def expected(x, w1, w2, w3, j):
        ...
        y1 = relay.strided_slice(y, [0, 0], [None, j])
        y2 = relay.strided_slice(y, [0, j], [None, 3 * j])
        y3 = relay.strided_slice(y, [0, 3 * j], [None, 6 * j])
        y = relay.Tuple((y1, y2, y3))
        return relay.Function(args, y)
...
def test_combine_parallel_dense_flat_biasadd():
    ...
    def expected(x, w1, w2, b1, b2, j, is_2d_bias):
        args = [x, w1, w2, b1, b2]
